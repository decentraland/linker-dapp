...
export async function getLandContract(landRegistry?: string) {
  if (!contractInstances.land) {
    ...
    if (provider) {
      const address =
        landRegistry ||
        (isRopsten() ? '0x7a73483784ab79257bb11b96fd62a2c3ae4fb75b' : '0xf87e31492faf9a91b02ee0deaad50d51d56d5d4d')
...
export async function getEstateContract(estateRegistry?: string) {
  if (!contractInstances.estate) {
    ...
    if (provider) {
      const address =
        estateRegistry ||
        (isRopsten() ? '0x124bf28a423b2ca80b3846c3aa0eb944fe7ebb95' : '0x959e104e1a4db6317fa58f8295f586e1a978c297')
